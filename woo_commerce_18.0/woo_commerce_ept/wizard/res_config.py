...
class WooInstanceConfig(models.TransientModel):
    ...
    woo_warehouse_id = fields.Many2one('stock.warehouse', string='Warehouse')
    ...
    def prepare_val_for_instance_create(self, consumer_key, consumer_secret, host, verify_ssl, version):
        ...
        print("warehousewarehouse", self.woo_company_id, warehouse)
        ...
        print("instance_valsinstance_vals",instance_vals)
        instance_vals
        return instance_vals
